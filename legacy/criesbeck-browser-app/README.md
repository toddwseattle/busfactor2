> Legacy migration snapshot from
> [`criesbeck/busfactor`](https://github.com/criesbeck/busfactor).
>
> These files are preserved for Busfactor2 migration reference. Do not modify
> this snapshot unless intentionally updating the legacy baseline.
